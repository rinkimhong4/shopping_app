...
class ContactPreferenceItems extends StatelessWidget {
  ...
  Widget _buildFooterApp(BuildContext context) {
    List<Map<String, dynamic>> contactSocial = [
      {'icon': Icons.phone, 'contact': '+855 86 240668'},
      {'icon': Icons.email_outlined, 'contact': 'rinkimhong4@gmail.com'},
      {
    ...
    List companyContent = ['About us', 'Blog', 'Contact'];
    List LegalItem = [
      'Privacy Policy',
      'Terms & Services',
      'Terms of Use',
    ...
    List quickLinkItem = ['Techlabz Keybox', 'Downloads', 'Forum'];
    return Column(
      children: [
        Container(
          width: double.infinity,
